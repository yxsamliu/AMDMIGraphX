...
PYBIND11_MODULE(migraphx, m)
{
    ...
    m.def("quantize_int8", [](migraphx::program& p, std::vector<std::string>& ins_names, std::vector<std::pair<float, float>>& quant_params) {
    ...
    m.def("quantize_int8", [](migraphx::program& p) {
