...
struct onnx_parser
{
    ...
    onnx_parser()
    {
        ...
        add_mem_op("ReduceL1", &onnx_parser::parse_reduce_oper<op::reduce_l1>);
        add_mem_op("ReduceL2", &onnx_parser::parse_reduce_oper<op::reduce_l2>);
        add_mem_op("ReduceLogSum", &onnx_parser::parse_reduce_oper<op::reduce_log_sum>);
        add_mem_op("ReduceLogSumExp", &onnx_parser::parse_reduce_oper<op::reduce_log_sum_exp>);
        ...
        add_mem_op("ReduceSumSquare", &onnx_parser::parse_reduce_oper<op::reduce_sum_square>);
