...
#include <migraphx/gpu/reduce_l1.hpp>
#include <migraphx/gpu/reduce_l2.hpp>
#include <migraphx/gpu/reduce_log_sum_exp.hpp>
#include <migraphx/gpu/reduce_log_sum.hpp>
#include <migraphx/gpu/reduce_max.hpp>
#include <migraphx/gpu/reduce_mean.hpp>
#include <migraphx/gpu/reduce_min.hpp>
#include <migraphx/gpu/reduce_prod.hpp>
#include <migraphx/gpu/reduce_sum.hpp>
#include <migraphx/gpu/reduce_sum_square.hpp>
...
struct miopen_apply
{
    ...
    void init()
    {
        ...
        add_extend_op<hip_reduce_l1, op::reduce_l1>("reduce_l1");
        add_extend_op<hip_reduce_l2, op::reduce_l2>("reduce_l2");
        add_extend_op<hip_reduce_log_sum, op::reduce_log_sum>("reduce_log_sum");
        add_extend_op<hip_reduce_log_sum_exp, op::reduce_log_sum_exp>("reduce_log_sum_exp");
        ...
        add_extend_op<hip_reduce_sum_square, op::reduce_sum_square>("reduce_sum_square");
