...
template struct test_reduce_op_small<migraphx::op::reduce_l1, 2, migraphx::shape::half_type>;
template struct test_reduce_op_small<migraphx::op::reduce_l2, 2, migraphx::shape::half_type>;
...
struct test_reduce_log_sum : verify_program<test_reduce_log_sum>
{
    migraphx::program create_program() const
    {
        migraphx::program p;
...
struct test_reduce_log_sum_exp : verify_program<test_reduce_log_sum_exp>
{
    migraphx::program create_program() const
    {
        migraphx::program p;
